...
public:
    ...
    LayeredProvingTree(ImplementedLogics logic, StatementPtrList &assumptions, StatementPtrList &steps,
                       StatementPtrList &goals, QTextBrowser *comment);
    ...
    // add verification results to standard model
    void addResultsToModel(QStandardItemModel *model);
    void printInfo();
    QTextBrowser *commentFrame;


private:
    class LPTNodePtrList : public LPTPtrList<LPTNode> {
    public:
        /*
    ...
    public:
        ...
        void addResultToModel(QStandardItem *parent);
